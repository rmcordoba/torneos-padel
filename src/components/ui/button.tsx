...
const BASE =
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-150 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-45 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0";
...
const VARIANTS: Record<string, string> = {
  ...
  ghost:       "bg-transparent text-[#94a3b8] border border-[oklch(28%_0.01_250)] hover:bg-[oklch(22%_0.012_250)] hover:text-[#e2e8f0]",
  link:        "text-[#a3e635] underline-offset-4 hover:underline",
  success:     "bg-[rgba(163,230,53,0.15)] text-[#a3e635] border border-[rgba(163,230,53,0.30)] hover:bg-[rgba(163,230,53,0.22)]",
